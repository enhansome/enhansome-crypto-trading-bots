...
* [freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 54,507 | 🐛 29 | 🌐 Python | 📅 2026-09-18 - Freqtrade is a free and open source crypto trading bot written in Python. It is designed to support all major exchanges and be controlled via Telegram. It contains backtesting, plotting and money management tools as well as strategy optimization by machine learning.
* [Nautilus](https://github.com/nautechsystems/nautilus_trader) ⭐ 29,114 | 🐛 135 | 🌐 Rust | 📅 2026-09-18 - Production-grade Rust-native trading engine with deterministic event-driven architecture
* [Backtrader](https://github.com/mementum/backtrader) ⭐ 23,275 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - A feature-rich Python framework for backtesting and trading.
...
* [jesse](https://github.com/jesse-ai/jesse) ⭐ 8,530 | 🐛 16 | 🌐 Python | 📅 2026-09-17 - Jesse is an advanced crypto trading framework which aims to simplify researching and defining trading strategies.
...
* [Octobot](https://github.com/Drakkar-Software/OctoBot) ⭐ 6,587 | 🐛 169 | 🌐 Python | 📅 2026-09-18 - Powerful fully modular open-source cryptocurrency trading bot with trading tools, a backtesting engine, an user interface, etc.
* [Superalgos](https://github.com/Superalgos/Superalgos) ⭐ 5,658 | 🐛 113 | 🌐 JavaScript | 📅 2026-09-18 - Superalgos is open-source crypto trading bot who let you visually design your crypto trading bot, leveraging an integrated charting system, data-mining, backtesting, paper trading, and multi-server crypto bot deployments.
...
* [K](https://github.com/ctubio/Krypto-trading-bot) ⭐ 3,715 | 🐛 64 | 🌐 C++ | 📅 2024-12-15 - K is a very low latency market making trading bot with a fully featured web interface. It can place and cancel orders on one of several supported cryptocoin exchanges in less than a few miliseconds per order on a decent machine.
* [crypto-trading-bot](https://github.com/Haehnchen/crypto-trading-bot) ⭐ 3,524 | 🐛 120 | 🌐 TypeScript | 📅 2026-08-02 - Crypto trading bot in Node.js for Bitfinex, Bitmex, and Binance.
* [OpenTrader](https://github.com/bludnic/opentrader) ⭐ 2,864 | 🐛 39 | 🌐 TypeScript | 📅 2025-06-29 - Self-hosted crypto trading bot featuring built-in strategies like GRID and DCA. Provides a UI for managing multiple bots, including paper trading and backtesting capabilities. Supports 100+ exchanges via CCXT.
...
* [ta-lib](https://github.com/mrjbq7/ta-lib) ⭐ 12,245 | 🐛 136 | 🌐 Cython | 📅 2026-09-15 - A widely used library by trading software developers requiring to perform technical analysis of financial market data.
* [ta](https://github.com/bukosabino/ta) ⭐ 5,224 | 🐛 158 | 🌐 Jupyter Notebook | 📅 2026-03-18 - A Technical Analysis library useful to do feature engineering from financial time series datasets (Open, Close, High, Low, Volume) built on Pandas and Numpy.
...
* [ta4j](https://github.com/ta4j/ta4j) ⭐ 2,491 | 🐛 15 | 🌐 Java | 📅 2026-09-18 - Ta4j is an open source Java library for technical analysis. It provides the basic components for creation, evaluation and execution of trading strategies.
...
* [ccxt](https://github.com/ccxt/ccxt) ⭐ 44,030 | 🐛 728 | 🌐 Rust | 📅 2026-09-18 - A well-established JavaScript / Python / PHP crypto trading library supporting more than 120 bitcoin/altcoin exchanges.
* [python-binance](https://github.com/sammchardy/python-binance) ⭐ 7,211 | 🐛 533 | 🌐 Python | 📅 2026-06-08 - Binance Exchange API python implementation for automated trading.
...
* [binance](https://github.com/tiagosiebler/binance) ⭐ 926 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-18 - A typed & heavily tested TypeScript/Node.js library for the Binance REST APIs and Websockets, available on npm, for the backend and the browser.
...
* [TradingView Lightweight Charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,305 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-18 - TradingView Lightweight Charts are one of the smallest and fastest financial HTML5 charts.
* [KLineChart ](https://github.com/klinecharts/KLineChart/) ⭐ 4,154 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-18 - Lightweight k-line chart that can be highly customized.
...
* [Wealthfolio](https://github.com/wealthfolio/wealthfolio) ⭐ 8,992 | 🐛 477 | 🌐 Rust | 📅 2026-09-18 - A beautiful, private, local-first personal finance tracker. Investments, net worth, spending, and simulations.
