...
* [freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 54,729 | 🐛 30 | 🌐 Python | 📅 2026-09-23 - Freqtrade is a free and open source crypto trading bot written in Python. It is designed to support all major exchanges and be controlled via Telegram. It contains backtesting, plotting and money management tools as well as strategy optimization by machine learning.
* [Nautilus](https://github.com/nautechsystems/nautilus_trader) ⭐ 29,319 | 🐛 139 | 🌐 Rust | 📅 2026-09-23 - Production-grade Rust-native trading engine with deterministic event-driven architecture
* [Backtrader](https://github.com/mementum/backtrader) ⭐ 23,312 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - A feature-rich Python framework for backtesting and trading.
...
* [jesse](https://github.com/jesse-ai/jesse) ⭐ 8,577 | 🐛 16 | 🌐 Python | 📅 2026-09-23 - Jesse is an advanced crypto trading framework which aims to simplify researching and defining trading strategies.
...
* [Octobot](https://github.com/Drakkar-Software/OctoBot) ⭐ 6,606 | 🐛 168 | 🌐 Python | 📅 2026-09-23 - Powerful fully modular open-source cryptocurrency trading bot with trading tools, a backtesting engine, an user interface, etc.
* [Superalgos](https://github.com/Superalgos/Superalgos) ⭐ 5,661 | 🐛 112 | 🌐 JavaScript | 📅 2026-09-23 - Superalgos is open-source crypto trading bot who let you visually design your crypto trading bot, leveraging an integrated charting system, data-mining, backtesting, paper trading, and multi-server crypto bot deployments.
...
* [K](https://github.com/ctubio/Krypto-trading-bot) ⭐ 3,713 | 🐛 64 | 🌐 C++ | 📅 2024-12-15 - K is a very low latency market making trading bot with a fully featured web interface. It can place and cancel orders on one of several supported cryptocoin exchanges in less than a few miliseconds per order on a decent machine.
* [crypto-trading-bot](https://github.com/Haehnchen/crypto-trading-bot) ⭐ 3,527 | 🐛 120 | 🌐 TypeScript | 📅 2026-08-02 - Crypto trading bot in Node.js for Bitfinex, Bitmex, and Binance.
* [OpenTrader](https://github.com/bludnic/opentrader) ⭐ 2,870 | 🐛 39 | 🌐 TypeScript | 📅 2025-06-29 - Self-hosted crypto trading bot featuring built-in strategies like GRID and DCA. Provides a UI for managing multiple bots, including paper trading and backtesting capabilities. Supports 100+ exchanges via CCXT.
  Production-grade Rust-native trading engine with deterministic event-driven architecture
* [Intelligent Trading Bot](https://github.com/asavinov/intelligent-trading-bot) ⭐ 1,870 | 🐛 46 | 🌐 Python | 📅 2026-08-30 - Automatically generating signals and trading based on machine learning and feature engineering
...
* [fast-trade](https://github.com/jrmeier/fast-trade) ⭐ 597 | 🐛 4 | 🌐 Python | 📅 2026-09-22 - Backtesting library utilizing pandas and technical analysis indicator, built with strategy portability and performance in mind for back-test trading strategies.
* [the0](https://github.com/alexanderwanyoike/the0) ⭐ 432 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-21 - Self-hosted execution engine for algorithmic trading bots. Write your strategy in Python, TypeScript, Rust, C++, C#, Scala, or Haskell and deploy with one command. Each bot runs in an isolated container.
* [magic8bot](https://github.com/magic8bot/magic8bot) ⭐ 411 | 🐛 11 | 🌐 TypeScript | 📅 2023-03-04 - Magic8bot is a cryptocurrency trading bot using Node.js and MongoDB.
...
* [ta-lib](https://github.com/mrjbq7/ta-lib) ⭐ 12,250 | 🐛 134 | 🌐 Cython | 📅 2026-09-21 - A widely used library by trading software developers requiring to perform technical analysis of financial market data.
* [ta](https://github.com/bukosabino/ta) ⭐ 5,226 | 🐛 159 | 🌐 Jupyter Notebook | 📅 2026-03-18 - A Technical Analysis library useful to do feature engineering from financial time series datasets (Open, Close, High, Low, Volume) built on Pandas and Numpy.
...
* [ta4j](https://github.com/ta4j/ta4j) ⭐ 2,492 | 🐛 16 | 🌐 Java | 📅 2026-09-23 - Ta4j is an open source Java library for technical analysis. It provides the basic components for creation, evaluation and execution of trading strategies.
...
* [ccxt](https://github.com/ccxt/ccxt) ⭐ 44,128 | 🐛 700 | 🌐 Python | 📅 2026-09-23 - A well-established JavaScript / Python / PHP crypto trading library supporting more than 120 bitcoin/altcoin exchanges.
...
* [TradingView Lightweight Charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,339 | 🐛 131 | 🌐 TypeScript | 📅 2026-09-21 - TradingView Lightweight Charts are one of the smallest and fastest financial HTML5 charts.
* [KLineChart ](https://github.com/klinecharts/KLineChart/) ⭐ 4,163 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-18 - Lightweight k-line chart that can be highly customized.
...
* [Wealthfolio](https://github.com/wealthfolio/wealthfolio) ⭐ 9,036 | 🐛 470 | 🌐 Rust | 📅 2026-09-23 - A beautiful, private, local-first personal finance tracker. Investments, net worth, spending, and simulations.
