...
* [freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 54,209 | 🐛 30 | 🌐 Python | 📅 2026-09-08 - Freqtrade is a free and open source crypto trading bot written in Python. It is designed to support all major exchanges and be controlled via Telegram. It contains backtesting, plotting and money management tools as well as strategy optimization by machine learning.
* [Nautilus](https://github.com/nautechsystems/nautilus_trader) ⭐ 28,712 | 🐛 128 | 🌐 Rust | 📅 2026-09-09 - Production-grade Rust-native trading engine with deterministic event-driven architecture
* [Backtrader](https://github.com/mementum/backtrader) ⭐ 23,172 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - A feature-rich Python framework for backtesting and trading.
...
* [jesse](https://github.com/jesse-ai/jesse) ⭐ 8,442 | 🐛 16 | 🌐 Python | 📅 2026-09-09 - Jesse is an advanced crypto trading framework which aims to simplify researching and defining trading strategies.
...
* [Octobot](https://github.com/Drakkar-Software/OctoBot) ⭐ 6,547 | 🐛 167 | 🌐 Python | 📅 2026-09-09 - Powerful fully modular open-source cryptocurrency trading bot with trading tools, a backtesting engine, an user interface, etc.
* [Superalgos](https://github.com/Superalgos/Superalgos) ⭐ 5,649 | 🐛 112 | 🌐 JavaScript | 📅 2026-09-09 - Superalgos is open-source crypto trading bot who let you visually design your crypto trading bot, leveraging an integrated charting system, data-mining, backtesting, paper trading, and multi-server crypto bot deployments.
* [CryptoSignal](https://github.com/CryptoSignal/Crypto-Signal) ⭐ 5,629 | 🐛 56 | 🌐 Python | 📅 2024-07-07 - Crypto trading bot in python for Bittrex, Binance, Bittrex, Bitfinex, Coinbase, etc.
* [K](https://github.com/ctubio/Krypto-trading-bot) ⭐ 3,709 | 🐛 64 | 🌐 C++ | 📅 2024-12-15 - K is a very low latency market making trading bot with a fully featured web interface. It can place and cancel orders on one of several supported cryptocoin exchanges in less than a few miliseconds per order on a decent machine.
* [crypto-trading-bot](https://github.com/Haehnchen/crypto-trading-bot) ⭐ 3,519 | 🐛 120 | 🌐 TypeScript | 📅 2026-08-02 - Crypto trading bot in Node.js for Bitfinex, Bitmex, and Binance.
* [OpenTrader](https://github.com/bludnic/opentrader) ⭐ 2,856 | 🐛 39 | 🌐 TypeScript | 📅 2025-06-29 - Self-hosted crypto trading bot featuring built-in strategies like GRID and DCA. Provides a UI for managing multiple bots, including paper trading and backtesting capabilities. Supports 100+ exchanges via CCXT.
...
* [fast-trade](https://github.com/jrmeier/fast-trade) ⭐ 592 | 🐛 3 | 🌐 Python | 📅 2026-08-22 - Backtesting library utilizing pandas and technical analysis indicator, built with strategy portability and performance in mind for back-test trading strategies.
* [the0](https://github.com/alexanderwanyoike/the0) ⭐ 427 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-01 - Self-hosted execution engine for algorithmic trading bots. Write your strategy in Python, TypeScript, Rust, C++, C#, Scala, or Haskell and deploy with one command. Each bot runs in an isolated container.
...
* [Planar](https://github.com/psydyllic/Planar.jl) ⭐ 11 | 🐛 1 | 🌐 Julia | 📅 2026-09-09 - Fast, flexible and featureful crypto trading bot (and framework) written in Julia, based on CCXT.
...
* [ta-lib](https://github.com/mrjbq7/ta-lib) ⭐ 12,239 | 🐛 136 | 🌐 Cython | 📅 2026-09-09 - A widely used library by trading software developers requiring to perform technical analysis of financial market data.
* [ta](https://github.com/bukosabino/ta) ⭐ 5,217 | 🐛 157 | 🌐 Jupyter Notebook | 📅 2026-03-18 - A Technical Analysis library useful to do feature engineering from financial time series datasets (Open, Close, High, Low, Volume) built on Pandas and Numpy.
...
* [ta4j](https://github.com/ta4j/ta4j) ⭐ 2,487 | 🐛 15 | 🌐 Java | 📅 2026-09-09 - Ta4j is an open source Java library for technical analysis. It provides the basic components for creation, evaluation and execution of trading strategies.
...
* [TechAn](https://github.com/sdcoffey/techan) ⭐ 908 | 🐛 17 | 🌐 Go | 📅 2026-09-04 - TechAn is a technical analysis library for Go! It provides basic and advanced technical analysis indicators, profit and trade analysis and strategy building.
* [ta-rs](https://github.com/greyblake/ta-rs) ⭐ 873 | 🐛 15 | 🌐 Rust | 📅 2024-07-12 -  Technical analysis library for Rust language.
...
* [ccxt](https://github.com/ccxt/ccxt) ⭐ 43,935 | 🐛 847 | 🌐 Python | 📅 2026-09-09 - A well-established JavaScript / Python / PHP crypto trading library supporting more than 120 bitcoin/altcoin exchanges.
* [python-binance](https://github.com/sammchardy/python-binance) ⭐ 7,207 | 🐛 533 | 🌐 Python | 📅 2026-06-08 - Binance Exchange API python implementation for automated trading.
...
* [TradingView Lightweight Charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,219 | 🐛 135 | 🌐 TypeScript | 📅 2026-09-09 - TradingView Lightweight Charts are one of the smallest and fastest financial HTML5 charts.
* [KLineChart ](https://github.com/klinecharts/KLineChart/) ⭐ 4,129 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-30 - Lightweight k-line chart that can be highly customized.
* [TradingVue.js](https://github.com/tvjsx/trading-vue-js) ⭐ 2,300 | 🐛 77 | 🌐 JavaScript | 📅 2024-06-24 - Hackable charting library for traders built for vue.js applications.
...
* [Wealthfolio](https://github.com/wealthfolio/wealthfolio) ⭐ 8,835 | 🐛 457 | 🌐 Rust | 📅 2026-09-09 - A beautiful, private, local-first personal finance tracker. Investments, net worth, spending, and simulations.
...
* [Awesome Crypto API Node.js Examples](https://github.com/tiagosiebler/awesome-crypto-examples) ⭐ 98 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-09 - A collection of examples for working with various crypto exchange APIs and WebSockets.
