...
* [freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 54,276 | 🐛 29 | 🌐 Python | 📅 2026-09-10 - Freqtrade is a free and open source crypto trading bot written in Python. It is designed to support all major exchanges and be controlled via Telegram. It contains backtesting, plotting and money management tools as well as strategy optimization by machine learning.
* [Nautilus](https://github.com/nautechsystems/nautilus_trader) ⭐ 28,789 | 🐛 130 | 🌐 Rust | 📅 2026-09-11 - Production-grade Rust-native trading engine with deterministic event-driven architecture
* [Backtrader](https://github.com/mementum/backtrader) ⭐ 23,236 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - A feature-rich Python framework for backtesting and trading.
...
* [jesse](https://github.com/jesse-ai/jesse) ⭐ 8,454 | 🐛 16 | 🌐 Python | 📅 2026-09-10 - Jesse is an advanced crypto trading framework which aims to simplify researching and defining trading strategies.
...
* [Octobot](https://github.com/Drakkar-Software/OctoBot) ⭐ 6,559 | 🐛 167 | 🌐 Python | 📅 2026-09-11 - Powerful fully modular open-source cryptocurrency trading bot with trading tools, a backtesting engine, an user interface, etc.
* [Superalgos](https://github.com/Superalgos/Superalgos) ⭐ 5,647 | 🐛 113 | 🌐 JavaScript | 📅 2026-09-11 - Superalgos is open-source crypto trading bot who let you visually design your crypto trading bot, leveraging an integrated charting system, data-mining, backtesting, paper trading, and multi-server crypto bot deployments.
* [CryptoSignal](https://github.com/CryptoSignal/Crypto-Signal) ⭐ 5,632 | 🐛 56 | 🌐 Python | 📅 2024-07-07 - Crypto trading bot in python for Bittrex, Binance, Bittrex, Bitfinex, Coinbase, etc.
...
* [OpenTrader](https://github.com/bludnic/opentrader) ⭐ 2,857 | 🐛 39 | 🌐 TypeScript | 📅 2025-06-29 - Self-hosted crypto trading bot featuring built-in strategies like GRID and DCA. Provides a UI for managing multiple bots, including paper trading and backtesting capabilities. Supports 100+ exchanges via CCXT.
...
* [fast-trade](https://github.com/jrmeier/fast-trade) ⭐ 593 | 🐛 3 | 🌐 Python | 📅 2026-08-22 - Backtesting library utilizing pandas and technical analysis indicator, built with strategy portability and performance in mind for back-test trading strategies.
...
* [ta-lib](https://github.com/mrjbq7/ta-lib) ⭐ 12,242 | 🐛 136 | 🌐 Cython | 📅 2026-09-09 - A widely used library by trading software developers requiring to perform technical analysis of financial market data.
* [ta](https://github.com/bukosabino/ta) ⭐ 5,219 | 🐛 158 | 🌐 Jupyter Notebook | 📅 2026-03-18 - A Technical Analysis library useful to do feature engineering from financial time series datasets (Open, Close, High, Low, Volume) built on Pandas and Numpy.
...
* [ta4j](https://github.com/ta4j/ta4j) ⭐ 2,487 | 🐛 15 | 🌐 Java | 📅 2026-09-11 - Ta4j is an open source Java library for technical analysis. It provides the basic components for creation, evaluation and execution of trading strategies.
...
* [ccxt](https://github.com/ccxt/ccxt) ⭐ 43,953 | 🐛 827 | 🌐 Rust | 📅 2026-09-11 - A well-established JavaScript / Python / PHP crypto trading library supporting more than 120 bitcoin/altcoin exchanges.
...
* [TradingView Lightweight Charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,240 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-10 - TradingView Lightweight Charts are one of the smallest and fastest financial HTML5 charts.
* [KLineChart ](https://github.com/klinecharts/KLineChart/) ⭐ 4,133 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-30 - Lightweight k-line chart that can be highly customized.
...
* [Wealthfolio](https://github.com/wealthfolio/wealthfolio) ⭐ 8,862 | 🐛 464 | 🌐 Rust | 📅 2026-09-11 - A beautiful, private, local-first personal finance tracker. Investments, net worth, spending, and simulations.
