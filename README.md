...
* [freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 54,484 | 🐛 28 | 🌐 Python | 📅 2026-09-17 - Freqtrade is a free and open source crypto trading bot written in Python. It is designed to support all major exchanges and be controlled via Telegram. It contains backtesting, plotting and money management tools as well as strategy optimization by machine learning.
* [Nautilus](https://github.com/nautechsystems/nautilus_trader) ⭐ 29,082 | 🐛 135 | 🌐 Rust | 📅 2026-09-17 - Production-grade Rust-native trading engine with deterministic event-driven architecture
...
* [jesse](https://github.com/jesse-ai/jesse) ⭐ 8,531 | 🐛 16 | 🌐 Python | 📅 2026-09-17 - Jesse is an advanced crypto trading framework which aims to simplify researching and defining trading strategies.
...
* [Octobot](https://github.com/Drakkar-Software/OctoBot) ⭐ 6,585 | 🐛 170 | 🌐 Python | 📅 2026-09-17 - Powerful fully modular open-source cryptocurrency trading bot with trading tools, a backtesting engine, an user interface, etc.
* [Superalgos](https://github.com/Superalgos/Superalgos) ⭐ 5,657 | 🐛 113 | 🌐 JavaScript | 📅 2026-09-17 - Superalgos is open-source crypto trading bot who let you visually design your crypto trading bot, leveraging an integrated charting system, data-mining, backtesting, paper trading, and multi-server crypto bot deployments.
...
* [OpenTrader](https://github.com/bludnic/opentrader) ⭐ 2,865 | 🐛 39 | 🌐 TypeScript | 📅 2025-06-29 - Self-hosted crypto trading bot featuring built-in strategies like GRID and DCA. Provides a UI for managing multiple bots, including paper trading and backtesting capabilities. Supports 100+ exchanges via CCXT.
...
* [Planar](https://github.com/psydyllic/Planar.jl) ⭐ 11 | 🐛 1 | 🌐 Julia | 📅 2026-09-17 - Fast, flexible and featureful crypto trading bot (and framework) written in Julia, based on CCXT.
...
* [ta-lib](https://github.com/mrjbq7/ta-lib) ⭐ 12,247 | 🐛 137 | 🌐 Cython | 📅 2026-09-15 - A widely used library by trading software developers requiring to perform technical analysis of financial market data.
...
* [ta4j](https://github.com/ta4j/ta4j) ⭐ 2,489 | 🐛 14 | 🌐 Java | 📅 2026-09-17 - Ta4j is an open source Java library for technical analysis. It provides the basic components for creation, evaluation and execution of trading strategies.
...
* [ccxt](https://github.com/ccxt/ccxt) ⭐ 44,025 | 🐛 719 | 🌐 Rust | 📅 2026-09-17 - A well-established JavaScript / Python / PHP crypto trading library supporting more than 120 bitcoin/altcoin exchanges.
...
* [node-binance-api](https://github.com/jaggedsoft/node-binance-api) ⭐ 1,668 | 🐛 291 | 🌐 TypeScript | 📅 2026-09-07 - A Node.js library for the Binance API designed to be easy to use.
* [binance](https://github.com/tiagosiebler/binance) ⭐ 926 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-01 - A typed & heavily tested TypeScript/Node.js library for the Binance REST APIs and Websockets, available on npm, for the backend and the browser.
...
* [okx-api](https://github.com/tiagosiebler/okx-api) ⭐ 167 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-01 - A typed & heavily tested TypeScript/Node.js library for the OKX (OKEX) REST APIs and Websockets, available on npm, for the backend and the browser.
...
* [TradingView Lightweight Charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,292 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-16 - TradingView Lightweight Charts are one of the smallest and fastest financial HTML5 charts.
* [KLineChart ](https://github.com/klinecharts/KLineChart/) ⭐ 4,152 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-15 - Lightweight k-line chart that can be highly customized.
...
* [Wealthfolio](https://github.com/wealthfolio/wealthfolio) ⭐ 8,974 | 🐛 474 | 🌐 Rust | 📅 2026-09-17 - A beautiful, private, local-first personal finance tracker. Investments, net worth, spending, and simulations.
