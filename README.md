...
* [freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 53,632 | 🐛 31 | 🌐 Python | 📅 2026-08-25 - Freqtrade is a free and open source crypto trading bot written in Python. It is designed to support all major exchanges and be controlled via Telegram. It contains backtesting, plotting and money management tools as well as strategy optimization by machine learning.
* [Nautilus](https://github.com/nautechsystems/nautilus_trader) ⭐ 27,787 | 🐛 112 | 🌐 Rust | 📅 2026-08-25 - Production-grade Rust-native trading engine with deterministic event-driven architecture
* [Backtrader](https://github.com/mementum/backtrader) ⭐ 22,961 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - A feature-rich Python framework for backtesting and trading.
...
* [jesse](https://github.com/jesse-ai/jesse) ⭐ 8,377 | 🐛 17 | 🌐 Python | 📅 2026-08-25 - Jesse is an advanced crypto trading framework which aims to simplify researching and defining trading strategies.
...
* [Octobot](https://github.com/Drakkar-Software/OctoBot) ⭐ 6,463 | 🐛 166 | 🌐 Python | 📅 2026-08-25 - Powerful fully modular open-source cryptocurrency trading bot with trading tools, a backtesting engine, an user interface, etc.
* [Superalgos](https://github.com/Superalgos/Superalgos) ⭐ 5,622 | 🐛 114 | 🌐 JavaScript | 📅 2026-08-25 - Superalgos is open-source crypto trading bot who let you visually design your crypto trading bot, leveraging an integrated charting system, data-mining, backtesting, paper trading, and multi-server crypto bot deployments.
* [CryptoSignal](https://github.com/CryptoSignal/Crypto-Signal) ⭐ 5,616 | 🐛 56 | 🌐 Python | 📅 2024-07-07 - Crypto trading bot in python for Bittrex, Binance, Bittrex, Bitfinex, Coinbase, etc.
* [K](https://github.com/ctubio/Krypto-trading-bot) ⭐ 3,706 | 🐛 64 | 🌐 C++ | 📅 2024-12-15 - K is a very low latency market making trading bot with a fully featured web interface. It can place and cancel orders on one of several supported cryptocoin exchanges in less than a few miliseconds per order on a decent machine.
* [crypto-trading-bot](https://github.com/Haehnchen/crypto-trading-bot) ⭐ 3,514 | 🐛 120 | 🌐 TypeScript | 📅 2026-08-02 - Crypto trading bot in Node.js for Bitfinex, Bitmex, and Binance.
* [OpenTrader](https://github.com/bludnic/opentrader) ⭐ 2,831 | 🐛 39 | 🌐 TypeScript | 📅 2025-06-29 - Self-hosted crypto trading bot featuring built-in strategies like GRID and DCA. Provides a UI for managing multiple bots, including paper trading and backtesting capabilities. Supports 100+ exchanges via CCXT.
  Production-grade Rust-native trading engine with deterministic event-driven architecture
* [Intelligent Trading Bot](https://github.com/asavinov/intelligent-trading-bot) ⭐ 1,856 | 🐛 47 | 🌐 Python | 📅 2026-08-11 - Automatically generating signals and trading based on machine learning and feature engineering
...
* [QtBitcoinTrader](https://github.com/JulyIghor/QtBitcoinTrader) ⭐ 798 | 🐛 53 | 🌐 C++ | 📅 2025-06-25 - Secure multi crypto exchange trading client. This software helps you open and cancel orders very fast. Real time data monitoring. Developed on pure Qt, uses OpenSSL, AES 256 key and secret protection.
...
* [Cassandre](https://github.com/cassandre-tech/cassandre-trading-bot) ⭐ 658 | 🐛 19 | 🌐 Java | 📅 2025-03-01 -  Cassandre makes it easy to create and run a Java crypto trading bot. Cassandre takes care of exchange connections, accounts, orders, and position management.
* [fast-trade](https://github.com/jrmeier/fast-trade) ⭐ 586 | 🐛 3 | 🌐 Python | 📅 2026-08-22 - Backtesting library utilizing pandas and technical analysis indicator, built with strategy portability and performance in mind for back-test trading strategies.
* [magic8bot](https://github.com/magic8bot/magic8bot) ⭐ 408 | 🐛 11 | 🌐 TypeScript | 📅 2023-03-04 - Magic8bot is a cryptocurrency trading bot using Node.js and MongoDB.
* [binance-futures-trading-bot](https://github.com/Erfaniaa/binance-futures-trading-bot) ⭐ 404 | 🐛 8 | 🌐 Python | 📅 2024-03-13 - Easy-to-use multi-strategic automatic trading for Binance Futures with Telegram integration
* [the0](https://github.com/alexanderwanyoike/the0) ⭐ 390 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-13 - Self-hosted execution engine for algorithmic trading bots. Write your strategy in Python, TypeScript, Rust, C++, C#, Scala, or Haskell and deploy with one command. Each bot runs in an isolated container.
...
* [Planar](https://github.com/psydyllic/Planar.jl) ⭐ 8 | 🐛 1 | 🌐 Julia | 📅 2026-08-25 - Fast, flexible and featureful crypto trading bot (and framework) written in Julia, based on CCXT.
...
* [ta-lib](https://github.com/mrjbq7/ta-lib) ⭐ 12,204 | 🐛 137 | 🌐 Cython | 📅 2026-07-29 - A widely used library by trading software developers requiring to perform technical analysis of financial market data.
* [ta](https://github.com/bukosabino/ta) ⭐ 5,180 | 🐛 156 | 🌐 Jupyter Notebook | 📅 2026-03-18 - A Technical Analysis library useful to do feature engineering from financial time series datasets (Open, Close, High, Low, Volume) built on Pandas and Numpy.
...
* [ta4j](https://github.com/ta4j/ta4j) ⭐ 2,480 | 🐛 14 | 🌐 Java | 📅 2026-08-25 - Ta4j is an open source Java library for technical analysis. It provides the basic components for creation, evaluation and execution of trading strategies.
* [technicalindicators](https://github.com/anandanand84/technicalindicators) ⭐ 2,452 | 🐛 86 | 🌐 JavaScript | 📅 2022-11-03 - A JS library with 20+ technical indicators and 30+ candlestick patterns.
...
* [ccxt](https://github.com/ccxt/ccxt) ⭐ 43,743 | 🐛 807 | 🌐 Python | 📅 2026-08-25 - A well-established JavaScript / Python / PHP crypto trading library supporting more than 120 bitcoin/altcoin exchanges.
...
* [binance](https://github.com/tiagosiebler/binance) ⭐ 925 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-24 - A typed & heavily tested TypeScript/Node.js library for the Binance REST APIs and Websockets, available on npm, for the backend and the browser.
...
* [TradingView Lightweight Charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,062 | 🐛 126 | 🌐 TypeScript | 📅 2026-08-21 - TradingView Lightweight Charts are one of the smallest and fastest financial HTML5 charts.
* [KLineChart ](https://github.com/klinecharts/KLineChart/) ⭐ 4,093 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-13 - Lightweight k-line chart that can be highly customized.
* [TradingVue.js](https://github.com/tvjsx/trading-vue-js) ⭐ 2,295 | 🐛 77 | 🌐 JavaScript | 📅 2024-06-24 - Hackable charting library for traders built for vue.js applications.
...
* [Wealthfolio](https://github.com/wealthfolio/wealthfolio) ⭐ 8,725 | 🐛 430 | 🌐 Rust | 📅 2026-08-25 - A beautiful, private, local-first personal finance tracker. Investments, net worth, spending, and simulations.
