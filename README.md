...
* [freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 53,350 | 🐛 33 | 🌐 Python | 📅 2026-08-16 - Freqtrade is a free and open source crypto trading bot written in Python. It is designed to support all major exchanges and be controlled via Telegram. It contains backtesting, plotting and money management tools as well as strategy optimization by machine learning.
* [Nautilus](https://github.com/nautechsystems/nautilus_trader) ⭐ 25,618 | 🐛 108 | 🌐 Rust | 📅 2026-08-16 - Production-grade Rust-native trading engine with deterministic event-driven architecture
* [Backtrader](https://github.com/mementum/backtrader) ⭐ 22,861 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - A feature-rich Python framework for backtesting and trading.
...
* [jesse](https://github.com/jesse-ai/jesse) ⭐ 8,329 | 🐛 11 | 🌐 Python | 📅 2026-08-16 - Jesse is an advanced crypto trading framework which aims to simplify researching and defining trading strategies.
...
* [Octobot](https://github.com/Drakkar-Software/OctoBot) ⭐ 6,413 | 🐛 163 | 🌐 Python | 📅 2026-08-14 - Powerful fully modular open-source cryptocurrency trading bot with trading tools, a backtesting engine, an user interface, etc.
* [Superalgos](https://github.com/Superalgos/Superalgos) ⭐ 5,614 | 🐛 115 | 🌐 JavaScript | 📅 2026-08-16 - Superalgos is open-source crypto trading bot who let you visually design your crypto trading bot, leveraging an integrated charting system, data-mining, backtesting, paper trading, and multi-server crypto bot deployments.
...
* [OpenTrader](https://github.com/bludnic/opentrader) ⭐ 2,823 | 🐛 39 | 🌐 TypeScript | 📅 2025-06-29 - Self-hosted crypto trading bot featuring built-in strategies like GRID and DCA. Provides a UI for managing multiple bots, including paper trading and backtesting capabilities. Supports 100+ exchanges via CCXT.
...
* [ta-rs](https://github.com/greyblake/ta-rs) ⭐ 872 | 🐛 15 | 🌐 Rust | 📅 2024-07-12 -  Technical analysis library for Rust language.
...
* [ccxt](https://github.com/ccxt/ccxt) ⭐ 43,643 | 🐛 761 | 🌐 Python | 📅 2026-08-16 - A well-established JavaScript / Python / PHP crypto trading library supporting more than 120 bitcoin/altcoin exchanges.
* [python-binance](https://github.com/sammchardy/python-binance) ⭐ 7,199 | 🐛 532 | 🌐 Python | 📅 2026-06-08 - Binance Exchange API python implementation for automated trading.
...
* [TradingView Lightweight Charts](https://github.com/tradingview/lightweight-charts) ⭐ 16,974 | 🐛 126 | 🌐 TypeScript | 📅 2026-08-12 - TradingView Lightweight Charts are one of the smallest and fastest financial HTML5 charts.
* [KLineChart ](https://github.com/klinecharts/KLineChart/) ⭐ 4,059 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-13 - Lightweight k-line chart that can be highly customized.
...
* [Wealthfolio](https://github.com/wealthfolio/wealthfolio) ⭐ 8,644 | 🐛 383 | 🌐 Rust | 📅 2026-08-14 - A beautiful, private, local-first personal finance tracker. Investments, net worth, spending, and simulations.
