...
* [freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 54,137 | 🐛 30 | 🌐 Python | 📅 2026-09-07 - Freqtrade is a free and open source crypto trading bot written in Python. It is designed to support all major exchanges and be controlled via Telegram. It contains backtesting, plotting and money management tools as well as strategy optimization by machine learning.
* [Nautilus](https://github.com/nautechsystems/nautilus_trader) ⭐ 28,616 | 🐛 119 | 🌐 Rust | 📅 2026-09-07 - Production-grade Rust-native trading engine with deterministic event-driven architecture
* [Backtrader](https://github.com/mementum/backtrader) ⭐ 23,156 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - A feature-rich Python framework for backtesting and trading.
...
* [jesse](https://github.com/jesse-ai/jesse) ⭐ 8,428 | 🐛 16 | 🌐 Python | 📅 2026-09-04 - Jesse is an advanced crypto trading framework which aims to simplify researching and defining trading strategies.
...
* [Octobot](https://github.com/Drakkar-Software/OctoBot) ⭐ 6,539 | 🐛 166 | 🌐 Python | 📅 2026-09-07 - Powerful fully modular open-source cryptocurrency trading bot with trading tools, a backtesting engine, an user interface, etc.
* [Superalgos](https://github.com/Superalgos/Superalgos) ⭐ 5,647 | 🐛 113 | 🌐 JavaScript | 📅 2026-09-07 - Superalgos is open-source crypto trading bot who let you visually design your crypto trading bot, leveraging an integrated charting system, data-mining, backtesting, paper trading, and multi-server crypto bot deployments.
* [CryptoSignal](https://github.com/CryptoSignal/Crypto-Signal) ⭐ 5,627 | 🐛 56 | 🌐 Python | 📅 2024-07-07 - Crypto trading bot in python for Bittrex, Binance, Bittrex, Bitfinex, Coinbase, etc.
...
* [OpenTrader](https://github.com/bludnic/opentrader) ⭐ 2,853 | 🐛 39 | 🌐 TypeScript | 📅 2025-06-29 - Self-hosted crypto trading bot featuring built-in strategies like GRID and DCA. Provides a UI for managing multiple bots, including paper trading and backtesting capabilities. Supports 100+ exchanges via CCXT.
  Production-grade Rust-native trading engine with deterministic event-driven architecture
* [Intelligent Trading Bot](https://github.com/asavinov/intelligent-trading-bot) ⭐ 1,873 | 🐛 46 | 🌐 Python | 📅 2026-08-30 - Automatically generating signals and trading based on machine learning and feature engineering
...
* [ta-lib](https://github.com/mrjbq7/ta-lib) ⭐ 12,237 | 🐛 137 | 🌐 Cython | 📅 2026-09-07 - A widely used library by trading software developers requiring to perform technical analysis of financial market data.
* [ta](https://github.com/bukosabino/ta) ⭐ 5,218 | 🐛 157 | 🌐 Jupyter Notebook | 📅 2026-03-18 - A Technical Analysis library useful to do feature engineering from financial time series datasets (Open, Close, High, Low, Volume) built on Pandas and Numpy.
...
* [ta4j](https://github.com/ta4j/ta4j) ⭐ 2,487 | 🐛 14 | 🌐 Java | 📅 2026-09-07 - Ta4j is an open source Java library for technical analysis. It provides the basic components for creation, evaluation and execution of trading strategies.
...
* [ccxt](https://github.com/ccxt/ccxt) ⭐ 43,910 | 🐛 853 | 🌐 Python | 📅 2026-09-07 - A well-established JavaScript / Python / PHP crypto trading library supporting more than 120 bitcoin/altcoin exchanges.
...
* [node-binance-api](https://github.com/jaggedsoft/node-binance-api) ⭐ 1,666 | 🐛 291 | 🌐 TypeScript | 📅 2026-09-07 - A Node.js library for the Binance API designed to be easy to use.
...
* [TradingView Lightweight Charts](https://github.com/tradingview/lightweight-charts) ⭐ 17,200 | 🐛 128 | 🌐 TypeScript | 📅 2026-09-07 - TradingView Lightweight Charts are one of the smallest and fastest financial HTML5 charts.
* [KLineChart ](https://github.com/klinecharts/KLineChart/) ⭐ 4,120 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-30 - Lightweight k-line chart that can be highly customized.
...
* [Wealthfolio](https://github.com/wealthfolio/wealthfolio) ⭐ 8,818 | 🐛 443 | 🌐 Rust | 📅 2026-09-07 - A beautiful, private, local-first personal finance tracker. Investments, net worth, spending, and simulations.
